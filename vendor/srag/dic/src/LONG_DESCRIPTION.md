...
```php
use srag\DIC\M365File\x\DICStatic;use srag\Plugins\x\x\x;DICStatic::dic()->database()->createAutoIncrement(x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\M365File\x\Version\PluginVersionParameter;
...
