...
namespace srag\DIC\M365File;

use ilLogLevel;
use ilPlugin;
use srag\DIC\M365File\DIC\DICInterface;
use srag\DIC\M365File\DIC\Implementation\ILIAS54DIC;
use srag\DIC\M365File\DIC\Implementation\ILIAS60DIC;
use srag\DIC\M365File\Exception\DICException;
use srag\DIC\M365File\Output\Output;
use srag\DIC\M365File\Output\OutputInterface;
use srag\DIC\M365File\Plugin\Plugin;
use srag\DIC\M365File\Plugin\PluginInterface;
use srag\DIC\M365File\Version\Version;
use srag\DIC\M365File\Version\VersionInterface;

/**
 * Class DICStatic
 *
 * @package srag\DIC\M365File
 *
