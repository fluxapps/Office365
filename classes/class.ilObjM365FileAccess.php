 ...
 */
class ilObjM365FileAccess extends ilObjectPluginAccess
{
    ...
    /**
     * ilObjM365FileAccess constructor
     */
    ...
    {
        $object_settings = self::m365File()->objectSettings()->getObjectSettingsById(intval($a_obj_id));
    ...
    {
        ilUtil::sendFailure(self::plugin()->translate("permission_denied", ilObjM365FileGUI::LANG_MODULE_OBJECT), true);
