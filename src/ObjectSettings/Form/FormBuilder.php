...
class FormBuilder extends AbstractFormBuilder
{
    ...
    {
        $buttons = [
            ilObjM365FileGUI::CMD_SETTINGS_STORE  => self::plugin()->translate("save", ilObjM365FileGUI::LANG_MODULE_SETTINGS),
            ilObjM365FileGUI::CMD_MANAGE_CONTENTS => self::plugin()->translate("cancel", ilObjM365FileGUI::LANG_MODULE_SETTINGS)
        ];
    ...
    {
        $fields = [
            "title"       => self::dic()->ui()->factory()->input()->field()->text(self::plugin()->translate("title", ilObjM365FileGUI::LANG_MODULE_SETTINGS))->withRequired(true),
            "description" => self::dic()->ui()->factory()->input()->field()->textarea(self::plugin()->translate("description", ilObjM365FileGUI::LANG_MODULE_SETTINGS)),
            "online"      => self::dic()->ui()->factory()->input()->field()->checkbox(self::plugin()->translate("online", ilObjM365FileGUI::LANG_MODULE_SETTINGS))
        ];
